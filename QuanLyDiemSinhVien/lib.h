...
void ThongTinChung() {
	TextColor(14);
	int y = 2;
	Gotoxy(42, y++); std::cout << "_|_|_|    _|_|_|_|_|  _|_|_|  _|_|_|_|_| ";
	Gotoxy(42, y++); std::cout << "_|    _|      _|        _|        _|     ";
	Gotoxy(42, y++); std::cout << "_|_|_|        _|        _|        _|    ";
	Gotoxy(42, y++); std::cout << "_|            _|        _|        _|    ";
	Gotoxy(42, y++); std::cout << "_|            _|      _|_|_|      _| ";
	TextColor(240);
	ShowCur(FALSE);
	...
	while (!_kbhit()) {
		...
		Gotoxy(30, 7);       std::cout << s;
		Gotoxy(30, 7); std::cout << " ";	   Sleep(200);
	}
	TextColor(14);
}
